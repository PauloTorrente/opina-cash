...
// CORREÇÃO: Remover referências ao tema
export const Select = styled.select`
  ...
  margin-top: 8px;
  width: 100%;
  background-color: #fff; /* Valor fixo */
  color: #000; /* Valor fixo */

  &:focus {
    outline: none;
    border-color: #28a745; /* Valor fixo */
  }
`;

// CORREÇÃO: Remover referências ao tema
export const CharacterLimitLabel = styled.label`
  display: block;
  margin-top: 15px;
  font-size: 14px;
  color: #6c757d; /* Valor fixo */
`;
